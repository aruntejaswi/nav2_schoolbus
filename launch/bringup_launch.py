...
def generate_launch_description():
    ...
    bringup_dir = get_package_share_directory("nav2_schoolbus")
    ...
    declare_map_yaml_cmd = DeclareLaunchArgument(
        "map", default_value="/home/dev/ros2_ws/src/nav2_schoolbus/maps/nav2_map.yaml", description="Full path to map yaml file to load"
    )
